...
class MiPod:
  ...
  def add_song(self, song):
    ...
    print("========================")
    choice = input(f"Would you like to add {song['title']} to your playlist? yes|no:")

    if choice == 'yes':
      self.songs.append(song)
      print(f"Successfully added {song['title']} to your playlist")
    else:
      print("Song skipped.")
...
''')
    ...
    choice = int(input(":"))
    if choice == 1:
      title = input("What song would you like to search?")
      my_pod.search_song(title)
    elif choice == 2:
      my_pod.view_playlist()
    elif choice == 3:
      break
